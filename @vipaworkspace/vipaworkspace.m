...
switch ed.Request
    ...
    case 'imageslist_useasrefimage'
        data = inputdlg({'Sig Image Num'},'Signal Image',[1],{'1'});
        calibrationobjid = {this.acquiretab.calibrationTextField.Text};
        [images,time] = this.ImagesList.getImages(ed.Variables(1));
        this.CalibrationList.setRefImage(calibrationobjid,images(:,:,str2double(data{1})));
    ...
    case 'imageslist_useassigimage'
        ...
        calibrationobjid = {this.acquiretab.calibrationTextField.Text};
        [images,time] = this.ImagesList.getImages(ed.Variables(1));
        this.CalibrationList.setSigImage(calibrationobjid,images(:,:,str2double(data{1})));
