...
public:
    ...
    CY_UTILS_LIB_API void* CY_CALLING_CONV operator new  ( size_t aSize, char* aUser, int aLine );
    CY_UTILS_LIB_API void* CY_CALLING_CONV operator new[]( size_t aSize, char* aUser, int aLine );
    ...
    CY_UTILS_LIB_API void  CY_CALLING_CONV operator delete  ( void* aPtr, char* aUser, int aLine );
    CY_UTILS_LIB_API void  CY_CALLING_CONV operator delete[]( void* aPtr, char* aUser, int aLine );
