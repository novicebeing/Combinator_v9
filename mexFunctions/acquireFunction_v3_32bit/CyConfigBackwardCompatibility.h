...
public:
    ...
    typedef unsigned long DataSendingMode;

public:
    CY_COM_LIB_API static const unsigned long MIN_ANSWER_TIMEOUT;
    CY_COM_LIB_API static const unsigned long MAX_ANSWER_TIMEOUT;
    CY_COM_LIB_API static const unsigned long DEFAULT_ANSWER_TIMEOUT;
    CY_COM_LIB_API static const unsigned long MIN_FIRST_PACKET_TIMEOUT;
    CY_COM_LIB_API static const unsigned long MAX_FIRST_PACKET_TIMEOUT;
    CY_COM_LIB_API static const unsigned long DEFAULT_FIRST_PACKET_TIMEOUT;
    CY_COM_LIB_API static const unsigned long MIN_PACKET_TIMEOUT;
    CY_COM_LIB_API static const unsigned long MAX_PACKET_TIMEOUT;
    CY_COM_LIB_API static const unsigned long DEFAULT_PACKET_TIMEOUT;
    CY_COM_LIB_API static const unsigned long MIN_REQUEST_TIMEOUT;
    CY_COM_LIB_API static const unsigned long MAX_REQUEST_TIMEOUT;
    CY_COM_LIB_API static const unsigned long DEFAULT_REQUEST_TIMEOUT;
    CY_COM_LIB_API static const unsigned long TIMEOUT_AUTO;
    CY_COM_LIB_API static const unsigned long MIN_PACKET_SIZE;
    CY_COM_LIB_API static const unsigned long MAX_PACKET_SIZE_UDP;
    CY_COM_LIB_API static const unsigned long MAX_PACKET_SIZE_DRV;
    CY_COM_LIB_API static const unsigned long DEFAULT_PACKET_SIZE_UDP;
    CY_COM_LIB_API static const unsigned long DEFAULT_PACKET_SIZE_DRV;
    CY_COM_LIB_API static const unsigned long MIN_COMMAND_RETRY_COUNT;
    CY_COM_LIB_API static const unsigned long MAX_COMMAND_RETRY_COUNT;
    CY_COM_LIB_API static const unsigned long DEFAULT_COMMAND_RETRY_COUNT;
    ...
    #define CY_IMPLEMENT_STRING_PARAMETER( aName, aID ) \
        ...
        { \
            ...
            strcpy( aValue, lValue.c_str_ascii() ); \
            return CY_RESULT_OK; \
        } \
    ...
    CY_IMPLEMENT_INT_PARAMETER( AnswerTimeOut, unsigned long, CY_CONFIG_PARAM_ANSWER_TIMEOUT );
    CY_IMPLEMENT_INT_PARAMETER( FirstPacketTimeOut, unsigned long, CY_CONFIG_PARAM_FIRST_PACKET_TIMEOUT );
    CY_IMPLEMENT_INT_PARAMETER( PacketTimeOut, unsigned long, CY_CONFIG_PARAM_PACKET_TIMEOUT );
    CY_IMPLEMENT_INT_PARAMETER( RequestTimeOut, unsigned long, CY_CONFIG_PARAM_REQUEST_TIMEOUT );
    CY_IMPLEMENT_INT_PARAMETER( PacketSize, unsigned long, CY_CONFIG_PARAM_PACKET_SIZE )
    CY_IMPLEMENT_INT_PARAMETER( CommandRetryCount, unsigned long, CY_CONFIG_PARAM_COMMAND_RETRY_COUNT );
    ...
    CY_IMPLEMENT_INT_PARAMETER( HeartbeatInterval, unsigned long, CY_CONFIG_PARAM_HEARTBEAT_INTERVAL );
    CY_IMPLEMENT_INT_PARAMETER( HeartbeatExpiration, unsigned long, CY_CONFIG_PARAM_HEARTBEAT_EXPIRATION );
