...
#define CY_GRABBER_PARAM_RGB_ENABLED_LABEL                          "RGN Enabled"
...
#define CY_GRABBER_PARAM_IMAGE_SEQUENCE_IN_DATA                     0x00000012
#define CY_GRABBER_PARAM_IMAGE_SEQUENCE_IN_DATA_LABEL               "Image Sequence In Data"
...
#define CY_GRABBER_PARAM_FORCE_SINGLE_SHOT                          0x00000040 // to 0x0000004F
#define CY_GRABBER_PARAM_FORCE_SINGLE_SHOT_LABEL                    "Force Single Shot"
                                                                    
#define CY_GRABBER_PARAM_FRAME_SKIP                                 0x00000050 // to 0x0000005F
#define CY_GRABBER_PARAM_FRAME_SKIP_LABEL                           "Frame Skip"
                                                                    
#define CY_GRABBER_PARAM_GPIO_TRIGGER                               0x00000060 // to 0x0000006F
#define CY_GRABBER_PARAM_GPIO_TRIGGER_LABEL                         "GPIO Trigger"
                                                                    
#define CY_GRABBER_PARAM_AUTO_INTERNAL_RETRIGGER                    0x00000070 // to 0x0000007F
#define CY_GRABBER_PARAM_AUTO_INTERNAL_RETRIGGER_LABEL              "Automatic Internal Retrigger"
                                                                    
#define CY_GRABBER_PARAM_PIPE_COUNT                                 0x00000080 // to 0x0000008F
...
#define CY_GRABBER_PARAM_TAP_RECONSTRUCTION_RIGHT_TO_LEFT           0x00000090 // to 0x0000009F
#define CY_GRABBER_PARAM_TAP_RECONSTRUCTION_RIGHT_TO_LEFT_LABEL     "Tap Right To Left"
                                                                    
#define CY_GRABBER_PARAM_TAP_RECONSTRUCTION_BOTTOM_TO_TOP           0x000000A0 // to 0x000000AF
