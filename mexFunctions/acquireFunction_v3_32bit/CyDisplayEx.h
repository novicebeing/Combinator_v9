...
public:
    ...
    // be opened
    static unsigned short   GetSystemDisplayCount();
    static CyResult         SetCurrentSystemDisplay( unsigned short aIndex );
    static unsigned short   GetCurrentSystemDisplay();
    ...
    static bool  PumpGUIMessage();

    // Returns a suggested number of columns and rows to use from a number of sub-display
    static unsigned short   GetColumnCount( unsigned short aSubDisplayCount );
    static unsigned short   GetRowCount( unsigned short aSubDisplayCount );

    // Returns the size of the current display
    static unsigned long    GetCurrentDisplayWidth();
    static unsigned long    GetCurrentDisplayHeight();
...
private:
    CyResult        InternalDisplay( const unsigned char * aBuffer,
                                     ...
                                     unsigned long         aFlags );
    CyResult        UpdateSubDisplay( unsigned short aIndex );
