...
//
// Description..: Image specific implement of CyBuffer (CyComLib)
//
// *****************************************************************************
//
// $Log$
...
class CyImageBuffer : public CyBuffer
{
// Constants
public:
...
public:
    ...
    // overrides of CyBuffer.  Do not use
	CY_CAM_LIB_API virtual CyResult
                                SetCapacity( unsigned int aSize );
...
public:
    ...
    CY_CAM_LIB_API static CyResult  SaveRaw   ( const CyString&       aFileName,
    ...
    CY_CAM_LIB_API static CyResult  LoadRaw   ( const CyString& aFileName,
    ...
    CY_CAM_LIB_API static CyResult  SaveBitmap( const CyString&       aFileName,
                                                const unsigned char*  aBuffer,
                                                unsigned long         aBufferSize,
...
// CyImageBuffer Handle
typedef void* CyImageBufferH;
