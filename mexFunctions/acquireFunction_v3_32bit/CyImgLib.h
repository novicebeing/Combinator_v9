...
// Define import/export symbols for Windows
    ...
    //
        ...
        #define CY_IMG_LIB_C_API CY_IMG_LIB_EXTERN_C __declspec(dllexport)
    ...
    //
        ...
        #define CY_IMG_LIB_C_API CY_IMG_LIB_EXTERN_C __declspec(dllimport)
