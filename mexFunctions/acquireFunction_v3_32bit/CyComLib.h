...
// Define import/export symbols for Windows
    ...
    //
        ...
        #define CY_COM_LIB_C_API CY_COM_LIB_EXTERN_C __declspec(dllexport)
    ...
    //
        ...
        #define CY_COM_LIB_C_API CY_COM_LIB_EXTERN_C __declspec(dllimport)
...
#else // defined( WIN32 ) && ! defined( CY_COM_LIB_STATIC )

    // Define the import/export symbols as nothing for this configuration
    #define CY_COM_LIB_API
    #define CY_COM_LIB_C_API

#endif // defined( WIN32) && ! defined( CY_COM_LIB_STATIC )
