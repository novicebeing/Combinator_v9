...
// Utilities
    ...
    CY_COM_LIB_API static bool     GetIdentifier( unsigned long  aMode, // CY_DEVICE_ACCESS_MODE_xxx in CyDeviceConstants
                                                  unsigned long  aIndex,
                                                  CyAdapterID&   aID );

    // Returns the IP of an adapter, based on index or ID
    CY_COM_LIB_API static bool     GetAdapterIP( unsigned long      aMode, // CY_DEVICE_ACCESS_MODE_xxx in CyDeviceConstants
                                                 unsigned long      aIndex,
                                                 CyString&          aIP );
    CY_COM_LIB_API static bool     GetAdapterIP( unsigned long      aMode, // CY_DEVICE_ACCESS_MODE_xxx in CyDeviceConstants
    ...
    CY_COM_LIB_API static bool     GetAdapterSubnetMask( unsigned long      aMode, // CY_DEVICE_ACCESS_MODE_xxx in CyDeviceConstants
                                                         unsigned long      aIndex,
                                                         CyString&          aNetMask );
    CY_COM_LIB_API static bool     GetAdapterSubnetMask( unsigned long      aMode, // CY_DEVICE_ACCESS_MODE_xxx in CyDeviceConstants
                                                         const CyAdapterID& aID,
