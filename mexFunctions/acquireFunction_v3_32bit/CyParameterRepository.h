...
typedef CyResult (CY_CALLING_CONV * CyParameterCallback )( unsigned long   aCallbackID,
                                                           ...
                                                           __int64         aValueI,     // used on for "SET" and "CHANGED"
...
public:
    ...
    // Returns the range of a preperty (floating point types)
    CY_UTILS_LIB_API virtual CyResult        GetParameterRangeByIndex( unsigned long   aIndex,
                                                                       double&         aMinValue,
...
protected:
    ...
    // Sets/Gets a parameters range (for integers)
    ...
    // Load the description of the parameters from a XML document file
    CY_UTILS_LIB_API virtual CyResult LoadParameterDescription      ( const CyString& aFileName,
                                                                      unsigned long   aID = CY_PARAMETER_INVALID_VALUE );
...
// CyParameterRepository Handle
typedef void* CyParameterRepositoryH;
...
CY_UTILS_LIB_C_API int CyParameterRepository_HasParameterByID( CyParameterRepositoryH aHandle,
                                                               unsigned long          aID );
CY_UTILS_LIB_C_API int CyParameterRepository_HasParameterNyName( CyParameterRepositoryH aHandle,
                                                                 const char*            aName );
...
CY_UTILS_LIB_C_API unsigned long CyParameterRepository_GetIdentifierNyName( CyParameterRepositoryH aHandle,
                                                                            const char*            aName  );
...
CY_UTILS_LIB_C_API unsigned long CyParameterRepository_GetParameterTypeByID   ( CyParameterRepositoryH aHandle,
                                                                                unsigned long          aID    );
CY_UTILS_LIB_C_API unsigned long CyParameterRepository_GetParameterTypeNyName ( CyParameterRepositoryH aHandle,
                                                                                const char*            aName  );
...
CY_UTILS_LIB_C_API CyResult CyParameterRepository_ShowDialog( CyParameterRepositoryH aHandle,
                                                              void*                  aParent );
