...
// CyPersistentRepository Handle
typedef void* CyPersistentRepositoryH;
...
// Methods
CY_UTILS_LIB_API void     CyPersistentRepository_GroupParametersInXML( CyPersistentRepositoryH aHandle,
                                                                       int                     aGroup );
CY_UTILS_LIB_API int      CyPersistentRepository_ParametersAreGroupedInXML( CyPersistentRepositoryH aHandle );
CY_UTILS_LIB_API CyResult CyPersistentRepository_SaveToXML  ( CyPersistentRepositoryH aHandle,
                                                              CyXMLDocumentH          aDocument );
CY_UTILS_LIB_API CyResult CyPersistentRepository_LoadFromXML( CyPersistentRepositoryH aHandle,
                                                              CyXMLDocumentH          aDocument );
