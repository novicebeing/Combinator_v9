...
// ===== Undocumented =====
public:
    CY_ENGINE_LIB_API virtual CyResult ReadConfig   ( unsigned long   lAddress,
                                                      unsigned long * lValue );
    CY_ENGINE_LIB_API virtual CyResult ReadConfig   ( unsigned long    lAddress,
                                                      unsigned short * lValue );
    CY_ENGINE_LIB_API virtual CyResult WriteConfig  ( unsigned long lAddress,
                                                      unsigned long lValue );
    CY_ENGINE_LIB_API virtual CyResult WriteConfig  ( unsigned long  lAddress,
                                                      unsigned short lValue );

    CY_ENGINE_LIB_API virtual CyResult ReadRegister ( unsigned long   lAddress,
                                                      unsigned long * lValue );
    CY_ENGINE_LIB_API virtual CyResult ReadRegister ( unsigned long    lAddress,
                                                      unsigned short * lValue );
    CY_ENGINE_LIB_API virtual CyResult WriteRegister( unsigned long lAddress,
                                                      unsigned long lValue );
    CY_ENGINE_LIB_API virtual CyResult WriteRegister( unsigned long  lAddress,
                                                      unsigned short lValue );
...
protected:
    ...
    CY_ENGINE_LIB_API virtual unsigned long  GetNextBlockID() const;
...
// ===== Extensions =====
CY_ENGINE_LIB_API CyResult CyEngine_ConnectExtension   ( CyEngineH          aHandle,
                                                         CyEngineExtensionH aExtension );
CY_ENGINE_LIB_API CyResult CyEngine_DisconnectExtension( CyEngineH          aHandle,
                                                         CyEngineExtensionH aExtension );
