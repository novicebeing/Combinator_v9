...
// Define import/export symbols for Windows
    ...
    //
        ...
        #define CY_DISP_LIB_C_API CY_DISP_LIB_EXTERN_C __declspec(dllexport)
    ...
    //
        ...
        #define CY_DISP_LIB_C_API CY_DISP_LIB_EXTERN_C __declspec(dllimport)
