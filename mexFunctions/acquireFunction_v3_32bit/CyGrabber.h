...
public:
	CY_CAM_LIB_API CyGrabber( bool aMultiChannel = true, CyChannelID aChannel = 0 );
    CY_CAM_LIB_API CyGrabber( CyDevice& aDevice, bool aMultiChannel = true, CyChannelID aChannel = 0 );
	CY_CAM_LIB_API virtual ~CyGrabber( void );

// Linking / Unlinking from camera objects
public:
    CY_CAM_LIB_API virtual CyResult LinkTo    ( CyCameraInterface& aCamera );
    CY_CAM_LIB_API virtual CyResult UnlinkFrom( const CyCameraInterface& aCamera );
    CY_CAM_LIB_API virtual bool     IsLinkedTo( const CyCameraInterface& aCamera ) const;
...
CY_CAM_LIB_C_API CyGrabberH CyGrabber_Init    ( int aMultiChannel, CyChannelID aChannel );
CY_CAM_LIB_C_API CyGrabberH CyGrabber_Init2   ( CyDeviceH aDevice, int aMultiChannel, CyChannelID aChannel );
