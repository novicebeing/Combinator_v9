...
//
    ...
    // Wrappers for char type over __int64
    CY_IMPLEMENT_PARAMETER( char, __int64, 0 )

    // Wrappers for unsigned char type over __int64
    CY_IMPLEMENT_PARAMETER( unsigned char, __int64, 0 )
    
    // Wrappers for short over __int64
    CY_IMPLEMENT_PARAMETER( short, __int64, 0 )

    // Wrappers for unsigned short over __int64
    CY_IMPLEMENT_PARAMETER( unsigned short, __int64, 0 )

    // Wrappers for int over __int64
    CY_IMPLEMENT_PARAMETER( int, __int64, 0 )

    // Wrappers for unsigned int over __int64
    CY_IMPLEMENT_PARAMETER( unsigned int, __int64, 0 )

    // Wrappers for long over __int64
    CY_IMPLEMENT_PARAMETER( long, __int64, 0 )

    // Wrappers for unsigned long over __int64
    CY_IMPLEMENT_PARAMETER( unsigned long, __int64, 0 )

    // Wrappers for flaot over double
    CY_IMPLEMENT_PARAMETER( float, double, 0.0 )

    // Wrappers for bool over __int64
    CY_IMPLEMENT_PARAMETER_BOOL( bool, __int64, false )
...
//
    ...
    CY_IMPLEMENT_GET_BY_VALUE( Char, char, __int64 )
    CY_IMPLEMENT_GET_BY_VALUE( UChar, unsigned char, __int64 )
    CY_IMPLEMENT_GET_BY_VALUE( Short, short, __int64 )
    CY_IMPLEMENT_GET_BY_VALUE( UShort, unsigned short, __int64 )
    CY_IMPLEMENT_GET_BY_VALUE( Int, int, __int64 )
    CY_IMPLEMENT_GET_BY_VALUE( UInt, unsigned int, __int64 )
    CY_IMPLEMENT_GET_BY_VALUE( Long, long, __int64 )
    CY_IMPLEMENT_GET_BY_VALUE( ULong, unsigned long, __int64 )
    CY_IMPLEMENT_GET_BY_VALUE( Int64, __int64, __int64 )
    CY_IMPLEMENT_GET_BY_VALUE( Double, double, double )
    CY_IMPLEMENT_GET_BY_VALUE( Float, float, double )
    CY_IMPLEMENT_GET_BY_VALUE_BOOL( Bool, bool, __int64 )
...
//
    ...
    #define DEFINE_PARAMETER_INT( aID, aMin, aMax, aDefault, aReadOnly, aHidden, aVolatile, aPersistent, aAdvanced, aRestartRequired, aVital ) \
            AddParameter( aID##_LABEL, \
                          CY_PARAMETER_INT, \
                          static_cast<__int64>( aMin ), \
                          static_cast<__int64>( aMax ), \
                          aID, \
                          static_cast<__int64>( aDefault ) ); \
