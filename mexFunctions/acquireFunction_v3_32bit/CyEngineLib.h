...
// Define import/export symbols for Windows
    ...
    //
        ...
        #define CY_ENGINE_LIB_C_API CY_ENGINE_LIB_EXTERN_C __declspec(dllexport)
    ...
    //
        ...
        #define CY_ENGINE_LIB_C_API CY_ENGINE_LIB_EXTERN_C __declspec(dllimport)
